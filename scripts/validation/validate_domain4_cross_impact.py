"""
VALIDATION SCRIPT: Domain 4 (Digital & Social) Cross-Impact Analysis
===================================================================
WHAT THIS SCRIPT DOES:
This script validates the statistical integrity of the new Domain 4 model.
It proves that Internet Addiction (IAT) and Loneliness are valid predictors 
of Depression (totalphq) by running baseline Linear Regression and Random 
Forest models.

WHY IT IS USEFUL:
Use this to demonstrate to reviewers that the model is mathematically sound
and free of tautology. It outputs the top feature drivers (e.g. loneliness4) 
along with realistic R-squared metrics.

USAGE:
Run directly from the root directory:
`python scripts/validation/validate_domain4_cross_impact.py`
"""
